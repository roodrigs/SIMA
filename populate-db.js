...
// Função simples para gerar ID similar ao cuid/nanoid se necessário
...
// Limpa questões existentes para evitar duplicatas (na ordem correta para evitar erros de FK)
